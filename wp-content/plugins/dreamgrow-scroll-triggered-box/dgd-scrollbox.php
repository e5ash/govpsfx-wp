...
class DgdScrollbox {
	...
	$ip = $_SERVER['REMOTE_ADDR'];
        ...
        //$result = file_get_contents('http://admin.govpsfx.com/subscribe.php', false, $context); //отправляем запрос
        ...
        if ($result != '200') {
           die(json_encode(array('html'=>"Извините произошла ошибка!", 'status'=>'200')));
        }
