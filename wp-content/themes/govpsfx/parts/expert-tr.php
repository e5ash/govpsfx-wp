<tr>
	...
	<td>
		<div class="t-price">$<?= get_field('advisers_price') ?></div>
	</td>
	<td>
		<a class="t-btn btn --lg --b-white --radius" href="<?= get_permalink(); ?>" target="_blank"><?php esc_html_e('Получить бесплатно', 'govpsfx') ?></a>
	</td>
</tr>