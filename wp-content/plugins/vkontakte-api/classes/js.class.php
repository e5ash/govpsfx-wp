 ...
 * Class Darx_JS
 *
 * Класс для подключения JS файлов
 */
class Darx_JS {

	/**
     * Статическая коллекция скриптов, которые будут подключены на странице
	 * @var array
	 */
	...
	/**
	* Статический метод для добавления скрипта в массив $_scripts
	*
	* @param string $name Уникальное имя скрипта
	* @param string $src Адрес JS файла
	*/
	...
	/**
	 * Добавляет какой-то скрипт в конец страницы
	 */
	...
	/**
	 * Добавляет в футер скрипты из массива $_scripts
	 */
